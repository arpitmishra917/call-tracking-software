...
export declare class CampaignsService {
    ...
    assignPhoneNumber(workspaceId: string, campaignId: string, phoneNumberId: string): Promise<{
        id: string;
        workspace_id: string;
        created_at: Date;
        updated_at: Date;
    ...
    addBuyerToCampaign(workspaceId: string, campaignId: string, buyerId: string, priority: number): Promise<{
        id: string;
        workspace_id: string;
        created_at: Date;
        updated_at: Date;
