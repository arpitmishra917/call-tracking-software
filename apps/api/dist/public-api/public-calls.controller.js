...
], PublicCallsController.prototype, "listCalls", null);
__decorate([
    Get(':id'),
    RequireWorkspaceRoles(WorkspaceRole.OWNER, WorkspaceRole.ADMIN, WorkspaceRole.MEMBER, WorkspaceRole.VIEWER),
    __param(0, Param('workspaceId')),
    ...
    __metadata("design:returntype", Promise)
], PublicCallsController.prototype, "getCall", null);
PublicCallsController = __decorate([
