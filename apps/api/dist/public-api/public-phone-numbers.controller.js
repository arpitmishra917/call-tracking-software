...
let PublicPhoneNumbersController = class PublicPhoneNumbersController {
    phoneNumbersService;
...
], PublicPhoneNumbersController.prototype, "listNumbers", null);
__decorate([
    Get('search'),
    ...
    __metadata("design:returntype", Promise)
], PublicPhoneNumbersController.prototype, "searchNumbers", null);
__decorate([
    Post(),
    RequireWorkspaceRoles(WorkspaceRole.OWNER, WorkspaceRole.ADMIN),
    __param(0, Param('workspaceId')),
    ...
    __metadata("design:paramtypes", [String, String, String]),
    __metadata("design:returntype", Promise)
], PublicPhoneNumbersController.prototype, "provisionNumber", null);
__decorate([
    Put(':id'),
    RequireWorkspaceRoles(WorkspaceRole.OWNER, WorkspaceRole.ADMIN),
    __param(0, Param('workspaceId')),
    ...
    __metadata("design:paramtypes", [String, String, String]),
    __metadata("design:returntype", Promise)
], PublicPhoneNumbersController.prototype, "updateNumber", null);
__decorate([
    Delete(':id'),
    RequireWorkspaceRoles(WorkspaceRole.OWNER, WorkspaceRole.ADMIN),
    __param(0, Param('workspaceId')),
    ...
    __metadata("design:returntype", Promise)
], PublicPhoneNumbersController.prototype, "releaseNumber", null);
PublicPhoneNumbersController = __decorate([
    Controller('api/v1/workspaces/:workspaceId/phone-numbers'),
...
export { PublicPhoneNumbersController };
//# sourceMappingURL=public-phone-numbers.controller.js.map