...
## Purpose
Routing configurations tying numbers to buyers.

## Responsibilities
Manage campaigns logic for CallFlow.
...
## Backend
Implemented in `apps/api/src/routing/campaigns.controller.ts`.
...
## Tests
- `apps/api/test/`
- Associated `.spec.ts` files in `apps/api/src/routing/campaigns.controller.ts`
