...
## Purpose
Stores overarching call state and duration.

## Responsibilities
Manage calls logic for CallFlow.
...
## Backend
Implemented in `apps/api/src/calls/`.
...
## Tests
- `apps/api/test/`
- Associated `.spec.ts` files in `apps/api/src/calls/`
