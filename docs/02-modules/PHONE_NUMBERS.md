...
## Purpose
Number provisioning and status tracking. Links to Telnyx API.

## Responsibilities
Manage phone numbers logic for CallFlow.
...
## Backend
Implemented in `apps/api/src/phone-numbers/`.
...
## Important files
- `apps/api/src/phone-numbers/`
- `apps/api/src/prisma/schema.prisma`

## Tests
- `apps/api/test/`
- Associated `.spec.ts` files in `apps/api/src/phone-numbers/`
