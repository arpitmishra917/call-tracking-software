...
## Responsibilities
Manage buyers logic for CallFlow.
...
## Backend
Implemented in `apps/api/src/routing/buyers.controller.ts`.
...
## Tests
- `apps/api/test/`
- Associated `.spec.ts` files in `apps/api/src/routing/buyers.controller.ts`
