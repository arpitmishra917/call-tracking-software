...
## Responsibilities
Manage recordings logic for CallFlow.
...
## Backend
Implemented in `apps/api/src/telephony/recordings.controller.ts`.
...
## Important files
- `apps/api/src/telephony/recordings.controller.ts`
- `apps/api/src/prisma/schema.prisma`

## Tests
- `apps/api/test/`
- Associated `.spec.ts` files in `apps/api/src/telephony/recordings.controller.ts`
